  ...
  return (
    <div className="relative w-full h-dvh flex flex-col items-center justify-center bg-black">
      ...
      <div className="absolute bottom-[100px] text-center z-10">
        <h2 className="text-white text-2xl font-semibold mb-2">Login with Google</h2>
        <p className="font-mono text-gray-400 text-sm mb-6">Add Google login to your app in minutes</p>
        <button className="bg-white hover:bg-gray-100 text-black font-medium py-3 px-6 rounded-md flex items-center gap-3 mx-auto transition-colors duration-200">
